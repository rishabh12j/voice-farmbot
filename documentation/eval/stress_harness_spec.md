> **STATUS: IMPLEMENTED (2026-07-04) — this spec is historical.** The
> harness exists as `tools/stress_misclassification.py` (main), built to
> eval_strategy §5 with one addition: a `failed-safe` outcome for
> build-time rejections. Measured results (seed 42, 120 injections,
> unsafe-motion 0) live in `demo/eval_v2_results.md`.
