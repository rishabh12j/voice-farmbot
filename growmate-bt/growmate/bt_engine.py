"""
GrowMate Behaviour Tree Engine v2

Upgrades:
- FarmBot REST API live plant lookup (with YAML fallback)
- Dot-notation variable resolution: $plant_data.x
- check_plant_found condition node
- All node types: sequence, selector, robot_action, function_call,
  llm_reason, respond, condition, confirm, wait, set_var, log
"""
...
class BTEngine:
    ...
    def _mock_fetch_weather(self, location="Maynooth", days=3):
